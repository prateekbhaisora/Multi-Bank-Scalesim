...
# Handles the mapping of different types of data (ifmap, filter, and ofmap) to specific memory locations.
class memory_map:
    '''
    Initializes the memory map object with default parameters including the number of mappings, 
    number of banks, and lists to store mapping information.
    '''
    def __init__(self):
    ...
    '''
    Sets parameters for a single bank configuration. It sets the offset for the filter and ofmap mapping lists.    
    '''
    ...
    '''
    Scales the single bank parameters for multiple layers. It replicates the single bank mapping lists for the given number of layers.
    '''
    ...
    '''
    Sets parameters including the number of banks and reads mapping information from files if provided.
    '''
    ...
    '''
    Reads ifmap mapping from a file and populates the ifmap mapping list.
    '''
    ...
    '''
    Reads filter mapping from a file and populates the filter mapping list.
    '''
    ...
    '''
    Reads ofmap mapping from a file and populates the ofmap mapping list.
    '''
    ...
    '''
    Retrieves ifmap mapping for a given layer.
    '''
    ...
    '''
    Retrieves filter mapping for a given layer.
    '''
