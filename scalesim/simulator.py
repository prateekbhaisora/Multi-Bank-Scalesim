...
class simulator:
    ...
    def run(self):
        ...
        # So, for each layer in the topology, we are calling single_layer_sim from single_layer_sim.py
        for i in range(self.num_layers):
            ...
            # Single layer sim object list is used to aggregate single layer simulators for all the layers
        ...
        for single_layer_obj in self.single_layer_sim_object_list:
            ...
            if self.verbose:
                # Creates console reports using methods of single_layer_sim.py
            ...
            if self.save_trace:
                ...
                single_layer_obj.save_traces(self.top_path)     # Creates Trace Files
                if self.verbose:
                    print('Done!')
    ...
    # Based on the SRAM and DRAM Trace Files, we generate reports for BANDWIDTH, COMPUTE, and DETAILED_ACCESS.
    def generate_reports(self):
        ...
        # Logic for generating all the reports is in calc_report_data() of single_layer_sim.py
